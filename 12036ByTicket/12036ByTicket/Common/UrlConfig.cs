   ...
   public static class UrlConfig
    {
        ...
        public static string _query = "{A-Z}";
        /// <summary>
        /// 登录验证码
        /// </summary>
        public static string captcha = $"{baseUrl}/passport/captcha/captcha-image64?login_site=E&module=login&rand=sjrand&{0}&callback=jQuery19101281750664248975_1568437740605&_=1554298927293";
        /// <summary>
        /// 验证码校验
        /// </summary>
        public static string captcha_Check = $"{baseUrl}/passport/captcha/captcha-check?callback=jQuery19101281750664248975_1568437740605&answer={0}&rand=sjrand&login_site=E&_={1}";
        /// <summary>
        /// 登陆
        /// </summary>
